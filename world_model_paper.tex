...
an admissible decision. This paper proposes that dependent types are a serious
way to raise the formal precision of world models, because they let evidence
travel with state and make action depend on lawful composition.
\end{abstract}
